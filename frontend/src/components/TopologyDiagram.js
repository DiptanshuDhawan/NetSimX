      ...
      <div style={{ width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
        <svg width="100%" height="100%" viewBox="0 0 800 450" style={{ fontFamily: 'Inter, sans-serif' }}>
          <g transform="translate(0, 30)">
            ...
            {/* Interface Labels */}
            {/* R1 - S2 Link */}
            <text x="505" y="75" fill="#E2E8F0" fontSize="12" fontWeight="500">e0/0</text>
            <text x="495" y="130" fill="#E2E8F0" fontSize="12" fontWeight="500">e0/0</text>
            
            {/* S1 - S2 Trunk */}
            <text x="235" y="142" fill="#E2E8F0" fontSize="12" fontWeight="500">e0/0</text>
            <text x="445" y="142" fill="#E2E8F0" fontSize="12" fontWeight="500">e0/1</text>
            
            {/* S1 Access Ports */}
            <text x="145" y="185" fill="#E2E8F0" fontSize="12" fontWeight="500">e0/1</text>
            <text x="215" y="195" fill="#E2E8F0" fontSize="12" fontWeight="500">e0/2</text>
            
            {/* S2 Access Ports */}
            <text x="450" y="195" fill="#E2E8F0" fontSize="12" fontWeight="500">e0/2</text>
            <text x="515" y="185" fill="#E2E8F0" fontSize="12" fontWeight="500">e0/3</text>
